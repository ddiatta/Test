********************************************************************************	
** Description:This file creates climate variables for the Senegal data
...
**********************************
** Create the admin data to be merged
**********************************
...
drop 		ehdd_seasonx rainy_season
duplicates	drop
...
gen 		rainy_season=1 if month>=6 & month<=9 // June to Sept
replace 	rainy_season=0 if rainy_season==.
bysort		departement year month: egen swi_seasonx=sum(swi) if rainy_season==1 // seasonal SWI
bysort		departement year: egen swi_season=mean(swi_seasonx)
drop 		*x rainy_season
